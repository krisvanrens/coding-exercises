...
test_input "x" "Error: expected operand 1, got invalid token 'x'"
test_input "1 x +" "Error: expected operand 2, got invalid token 'x'"
test_input "x 2 +" "Error: expected operand 1, got invalid token 'x'"
test_input "1 2 x" "Error: expected operator, got invalid token 'x'"
test_input "abc" "Error: expected operand 1, got invalid token 'abc'"
test_input "x12" "Error: expected operand 1, got invalid token 'x12'"
test_input "12x" "Error: expected operand 1, got invalid token '12x'"
test_input "12*" "Error: expected operand 1, got invalid token '12*'"
test_input "ŮñĭçøƋɇ" "Error: input is not valid ASCII data"
